        ...
        <main className="container mx-auto px-4 sm:px-6 md:px-8 py-24 flex flex-col min-h-screen relative z-10">
          ...
          <div className="flex-grow mt-16 sm:mt-20 text-center space-y-6 px-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6 sm:mt-8 px-2">
              <Button variant="outline" size="lg" className="bg-black text-white border-black font-bold hover:bg-gray-800 hover:border-gray-800 cursor-not-allowed">
                Explore <ArrowRight className="h-4 w-4 ml-2" />
              </Button>
              <Button variant="outline" size="lg" className="bg-white text-black border-gray-300 font-bold hover:bg-gray-50 hover:border-gray-400 cursor-not-allowed">
          ...
          >
            {[
              ...
              { icon: <Coffee className="h-12 w-12 text-black" />, title: "Daily Disappointments", desc: "Share your daily struggles and workplace disasters" },
            ].map((card, idx) => (
              <div key={idx} className="p-6 rounded-2xl shadow-lg border bg-gradient-to-bl from-slate-300 via-slate-400 to-slate-500 flex flex-col items-center text-center hover:scale-105 transition-transform hover:shadow-indigo-400/40 hover:border-indigo-400">
